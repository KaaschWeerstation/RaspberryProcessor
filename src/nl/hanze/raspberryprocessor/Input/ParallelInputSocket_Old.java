...
public class ParallelInputSocket_Old implements Runnable {
    ...
    ParallelInputSocket_Old(MeasurementInputQueue measurementInputQueue, Socket connection, SemaphoreInteger semaphoreInteger) {
